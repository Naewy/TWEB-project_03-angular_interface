angular.module('state-manager').run(['$templateCache', function($templateCache) {
  'use strict';

  $templateCache.put('app/modules/administration/administration.html',
    "<div class=\"md-padding\" flex layout-sm=\"column\">\n" +
    "    <md-card>\n" +
    "        <md-card-content>\n" +
    "            <h2 class=\"md-title\">Content from: administration page</h2>\n" +
    "        </md-card-content>\n" +
    "    </md-card>\n" +
    "</div>\n"
  );
